...
extern int register_android_media_MediaHooker(JNIEnv *env); // add by flyer
...
jint JNI_OnLoad(JavaVM* vm, void* /* reserved */)
{
    ...
    // add by flyer
    if (register_android_media_MediaHooker(env) < 0) {
        ALOGE("ERROR: MediaHooker native registration failed");
        goto bail;
    }
